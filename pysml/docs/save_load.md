...
- **Used in scripts**: The distributed runtime guide (`ddp.md`) shows how to persist parallel strategy metadata between rehearsal runs so repeated launches can reuse weights without recomputing initial states.【F:pysml/docs/ddp.md†L40-L120】
- **Typical usage**:
  ```python
