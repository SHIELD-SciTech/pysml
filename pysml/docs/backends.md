...
- **Used in scripts**: The custom DDP guide walks through rehearsing pipeline splits on XPU hardware, and `ExampleConfig` accepts `backend="xpu"` to target these devices.【F:pysml/docs/ddp.md†L1-L40】【F:pysml/examples/parallel_utils.py†L11-L83】
- **Typical usage**:
  ```python
