"""
Automatic Mixed Precision (AMP) utilities for CUDA backend.
Lightweight autocast context for CuPy.
"""
...
def autocast(dtype="float16"):
    ...
    Example:
        ...
        >>> with amp.autocast(dtype="float16"):
        ...     y = matmul(x1, x2)
    """
...
def cast_tensor(t):
    """Cast tensor to AMP dtype if enabled."""
...
def autocast_function(fn):
    """Decorator to autocast inputs to AMP precision."""
